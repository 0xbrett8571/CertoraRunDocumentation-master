# Prover Release Notes — Certora Prover Documentation 0.0 documentation

# [Prover Release Notes](#id76)[](#prover-release-notes "Link to this heading")

## [8.6.3 (January 6, 2026)](#id77)[](#january-6-2026 "Link to this heading")

### [CVL](#id78)[](#cvl "Link to this heading")
...
## [8.5.1 (November 25, 2025)](#id79)[](#november-25-2025 "Link to this heading")

### [CVLM](#id80)[](#cvlm "Link to this heading")
...
### [CVL](#id81)[](#id2 "Link to this heading")
...
## [8.3.0 (October 5, 2025)](#id82)[](#october-5-2025 "Link to this heading")

### [Rule Report](#id83)[](#rule-report "Link to this heading")

*   \[feat\] Imprecisions are now reported as rule notifications and shown in the Call Trace labeled as `IMPRECISION`.
    

### [CVL](#id84)[](#id3 "Link to this heading")
...
## [8.1.0 (August 11, 2025)](#id85)[](#august-11-2025 "Link to this heading")

### [Infrastructure](#id86)[](#infrastructure "Link to this heading")
...
### [CVL](#id87)[](#id4 "Link to this heading")
...
### [Prover](#id88)[](#prover "Link to this heading")
...
### [CLI](#id89)[](#cli "Link to this heading")
...
### [Solana / Soroban](#id90)[](#solana-soroban "Link to this heading")
...
## [7.31.0 (June 30, 2025)](#id91)[](#june-30-2025 "Link to this heading")

### [CLI](#id92)[](#id5 "Link to this heading")
...
## [7.29.1 (May 18, 2025)](#id93)[](#may-18-2025 "Link to this heading")

### [CVL](#id94)[](#id6 "Link to this heading")

*   \[feat\] `require` statements now support an optional string reason argument: `require(condition, "reason")`. A warning will be shown in the Rule Notification tab for require statements likely to exclude meaningful traces, helping prevent false positives in verification.
    

### [CLI](#id95)[](#id7 "Link to this heading")
...
### [Solana](#id96)[](#solana "Link to this heading")

*   \[feat\] Jump-To-Source support for Solana function calls in the Call Trace.
    

## [7.28.0 (April 10, 2025)](#id97)[](#april-10-2025 "Link to this heading")

### [Rule Report](#id98)[](#id8 "Link to this heading")
...
### [CVLR](#id99)[](#cvlr "Link to this heading")
...
## [7.26.0 (Mar 13, 2025)](#id100)[](#mar-13-2025 "Link to this heading")

### [Rule Report](#id101)[](#id9 "Link to this heading")
...
### [CVL](#id102)[](#id10 "Link to this heading")
...
## [7.25.2 (Feb 19, 2025)](#id103)[](#feb-19-2025 "Link to this heading")

### [CVL](#id104)[](#id11 "Link to this heading")

*   \[feat\] CVL now supports native summation over ghost mapping variables with the new `sum` and `usum` keywords.
    

### [Prover](#id105)[](#id12 "Link to this heading")
...
### [CLI](#id106)[](#id13 "Link to this heading")
...
## [7.22.2 (Jan 12, 2025)](#id107)[](#jan-12-2025 "Link to this heading")

### [Rule Report](#id108)[](#id14 "Link to this heading")
...
### [Dashboard](#id109)[](#dashboard "Link to this heading")
...
## [7.21.1 (December 12, 2024)](#id110)[](#december-12-2024 "Link to this heading")

Various bug fixes and performance improvements.

## [7.20.1 (November 20, 2024)](#id111)[](#november-20-2024 "Link to this heading")

### [CVL](#id112)[](#id15 "Link to this heading")
...
### [Rule Report](#id113)[](#id16 "Link to this heading")
...
## [7.17.2 (October 8, 2024)](#id114)[](#october-8-2024 "Link to this heading")

### [CVL](#id115)[](#id17 "Link to this heading")
...
### [CLI](#id116)[](#id18 "Link to this heading")
...
### [Rule Report](#id117)[](#id19 "Link to this heading")
...
## [7.14.2 (September 2, 2024)](#id118)[](#september-2-2024 "Link to this heading")

### [CVL](#id119)[](#id20 "Link to this heading")
...
### [Rule Report](#id120)[](#id21 "Link to this heading")

*   \[feat\] Global Notifications New UI
    

## [7.10.1 (July 25, 2024)](#id121)[](#july-25-2024 "Link to this heading")

### [CVL](#id122)[](#id22 "Link to this heading")
...
### [Rule Report](#id123)[](#id23 "Link to this heading")
...
## [7.6.3 (May 15, 2024)](#id127)[](#may-15-2024 "Link to this heading")

### [CVL](#id128)[](#id25 "Link to this heading")
...
### [Rule Report](#id129)[](#id26 "Link to this heading")
...
### [Performance](#id130)[](#id27 "Link to this heading")

*   \[feat\] The `-splitParallel` option will now enable the new parallel splitter
    

### [CLI](#id131)[](#id28 "Link to this heading")
...
### [Misc.](#id132)[](#id29 "Link to this heading")

*   \[feat\] Support for `MCOPY` EVM instruction
    

## [7.3.0 (April 11, 2024)](#id133)[](#april-11-2024 "Link to this heading")

### [CVL](#id134)[](#id30 "Link to this heading")
...
*   \[feat\] [Dispatch-list summarization for calls with unresolved method identifiers](../../cvl/methods.html#catch-unresolved-calls-entry)
    
*   \[feat\] Preliminary support for `tload`, `tstore` operations in inline-assembly Solidity and EVM, along with `ALL_TLOAD` and `ALL_TSTORE` hooks, see [Transient Storage](../../cvl/transient.html#transient-storage) and [Hooking on all storage loads or stores](../../cvl/hooks.html#rawhooks)
    
*   \[feat\] [Support direct access to immutables, including private immutables](../../cvl/expr.html#direct-immutable-access)
    
*   \[feat\] grounding of quantifiers supported with direct storage access expressions
    
*   \[feat\] Support asterisk (\*) wildcard in `--rule`, and a new option for `--exclude_rule`, see [exclude\_rule](../cli/options.html#exclude-rule)
...
### [Rule Report](#id135)[](#id31 "Link to this heading")
...
### [Performance](#id136)[](#id32 "Link to this heading")
...
### [CLI](#id137)[](#id33 "Link to this heading")

*   \[feat\] [compilation\_steps\_only](../cli/options.html#compilation-steps-only) option is exposed (runs only compilation and type checking)
    
*   \[feat\] [precise\_bitwise\_ops](../cli/options.html#precise-bitwise-ops) to easily enable bit-vector theory solvers Mutation Testing
    

### [Mutation Testing](#id138)[](#mutation-testing "Link to this heading")
...
### [Misc.](#id139)[](#id34 "Link to this heading")
...
## [7.0.7 (March 15, 2024)](#id140)[](#march-15-2024 "Link to this heading")

### [CVL](#id141)[](#id35 "Link to this heading")
...
*   \[feat\] [Auto-summarization mode for heuristically expensive internal functions](../../user-guide/out-of-resources/timeout.html#detect-candidates-for-summarization)
    
*   \[feat\] Support hooking on length of dynamic storage arrays
    
*   \[feat\] [Support basic struct comparison](../../cvl/expr.html#struct-comparison)
...
### [Rule Report](#id142)[](#id36 "Link to this heading")
...
### [Static analysis and Performance](#id143)[](#static-analysis-and-performance "Link to this heading")
...
### [Mutation Testing](#id144)[](#id37 "Link to this heading")
...
### [CLI](#id145)[](#id38 "Link to this heading")
...
## [6.3.1 (February 2, 2024)](#id146)[](#february-2-2024 "Link to this heading")

### [CVL](#id147)[](#id39 "Link to this heading")

*   \[feat\] [Casting addresses to bytes32](../../cvl/cvl2/changes.html#address-casting)
    
*   \[feat\] [ECRecover](../../cvl/expr.html#ecrecover) builtin support
...
*   \[bugfix\] [Fully support additional environment fields](../../cvl/types.html#env). Namely, for `env e`, one can access `e.block.basefee`, `e.block.coinbase`, `e.block.difficulty`, `e.block.gaslimit` and `e.tx.origin`
...
### [Call Trace and Rule Report](#id148)[](#call-trace-and-rule-report "Link to this heading")
...
### [Static analysis and Performance](#id149)[](#id40 "Link to this heading")
...
### [Misc](#id150)[](#id41 "Link to this heading")
...
## [6.1.3 (January 11, 2024)](#id151)[](#january-11-2024 "Link to this heading")

### [CVL](#id152)[](#id42 "Link to this heading")
...
*   \[feat\] [Ghosts vs. persistent ghosts](../../cvl/ghosts.html#persistent-ghosts)
...
*   \[feat\] New options [optimistic\_summary\_recursion](../cli/options.html#optimistic-summary-recursion) and [summary\_recursion\_limit](../cli/options.html#summary-recursion-limit).
...
### [Performance](#id153)[](#id43 "Link to this heading")
...
### [Call Trace](#id154)[](#call-trace "Link to this heading")
...
### [Mutation Testing](#id155)[](#id44 "Link to this heading")
...
### [Misc](#id156)[](#id45 "Link to this heading")
...
## [5.0.5 (November 21, 2023)](#id157)[](#november-21-2023 "Link to this heading")

Please find a list of the main changes in v5 here [Certora CLI 5.0 Changes](../../cvl/v5-changes.html).

### [CVL](#id158)[](#id46 "Link to this heading")

*   \[feat\] Allowing calling Solidity functions from within CVL hooks
    
*   \[feat\] [Direct storage access](../../cvl/expr.html#direct-storage-access)
...
### [Performance](#id159)[](#id47 "Link to this heading")
...
### [Misc](#id160)[](#id48 "Link to this heading")
...
## [4.13.1 (September 26, 2023)](#id161)[](#september-26-2023 "Link to this heading")
...
## [4.12.1 (September 17, 2023)](#id162)[](#september-17-2023 "Link to this heading")

### [CVL](#id163)[](#id49 "Link to this heading")
...
### [Performance](#id164)[](#id50 "Link to this heading")
...
### [Call Trace & Rule Report](#id165)[](#call-trace-rule-report "Link to this heading")
...
### [CLI](#id166)[](#id51 "Link to this heading")
...
### [Mutation Verification](#id167)[](#mutation-verification "Link to this heading")
...
### [Equivalence Checker](#id168)[](#equivalence-checker "Link to this heading")
...
## [4.10.1 (August 21, 2023)](#id169)[](#august-21-2023 "Link to this heading")

### [CVL](#id170)[](#id52 "Link to this heading")

*   \[feat\] Support Solidity calls also from internal summaries
    
*   \[feat\] Allowing `with(env)` for summaries [with(env e) clauses](../../cvl/methods.html#with-env)
...
### [Mutation Verification](#id171)[](#id53 "Link to this heading")
...
### [Timeouts and performance](#id172)[](#timeouts-and-performance "Link to this heading")
...
### [Linking](#id173)[](#linking "Link to this heading")
...
### [Vyper](#id174)[](#vyper "Link to this heading")

*   \[bugfix\] Support for versions below 0.2.16 (from before storage layout output was introduced in Vyper)
    

## [4.8.0 (August 13, 2023)](#id175)[](#august-13-2023 "Link to this heading")

### [New features and enhancements](#id176)[](#new-features-and-enhancements "Link to this heading")

#### [CVL](#id177)[](#id54 "Link to this heading")

*   Better expressivity: `ALWAYS` summaries can get `bytesK` arguments, e.g. `... => ALWAYS(to_bytesK(...))`
    
*   Support for `ALL_SLOAD` and `ALL_SSTORE` hooks (see [Hooking on all storage loads or stores](../../cvl/hooks.html#rawhooks))
...
#### [Call Trace and Rule Report](#id178)[](#id55 "Link to this heading")
...
#### [Performance](#id179)[](#id56 "Link to this heading")
...
#### [Mutation Verifier](#id180)[](#mutation-verifier "Link to this heading")

*   Manual mutants now supported in `certoraMutate`
    

#### [Equivalence Checker](#id181)[](#id57 "Link to this heading")

*   Support for Vyper for the equivalence checker (`certoraEqCheck` utility)
    

#### [CLI](#id182)[](#id58 "Link to this heading")

*   Allowing more Solidity file names
    
*   More compact zip input to cloud
    
*   Users can reduce the global timeout below 2 hours using [global\_timeout](../cli/options.html#global-timeout)
    

### [Bug fixes](#id183)[](#bug-fixes "Link to this heading")

#### [CVL](#id184)[](#id59 "Link to this heading")
...
### [Other improvements](#id188)[](#other-improvements "Link to this heading")
...
## [4.5.1 (July 15, 2023)](#id189)[](#july-15-2023 "Link to this heading")

### [New features](#id190)[](#new-features "Link to this heading")

#### [CVL](#id191)[](#id63 "Link to this heading")

*   Better expressivity: Allow binding the called contract in summaries using `calledContract` (see [Expression summaries](../../cvl/methods.html#expression-summary))
...
*   Ease of use: Enum types can be cast to integer types in CVL using the usual `assert_TYPE` and `require_TYPE` operators (see [Changes to integer types](../../cvl/cvl2/changes.html#cvl2-integer-types))
    
*   A built-in rule for read-only reentrancy vulnerabilities
    

#### [Call Trace](#id192)[](#id64 "Link to this heading")

*   Better view of the storage state at storage assignments, storage restore points, and storage comparisons
    

#### [Multi-contract handling](#id193)[](#multi-contract-handling "Link to this heading")
...
*   Introducing `summarizeExtLibraryCallsAsNonDetPreLinking` Prover option for easier setup of library-heavy code. See [Library-based systems](../../user-guide/out-of-resources/timeout.html#library-timeouts)
    

#### [Mutation Verifier](#id194)[](#id65 "Link to this heading")

*   New and easier to use `certoraMutate`. See [Using Gambit with the Prover](../../gambit/mutation-verifier.html)
    

### [Bug fixes](#id195)[](#id66 "Link to this heading")

#### [CVL](#id196)[](#id67 "Link to this heading")
...
#### [Performance](#id197)[](#id68 "Link to this heading")
...
#### [UX](#id198)[](#ux "Link to this heading")

*   Show primary contract under verification even when a job is queued but not yet started
    
*   [envfree](../../cvl/methods.html#envfree) checks failures presented not just in rules section, but also in the problems view for highlighting
...
## [4.3.1 (July 2, 2023)](#id199)[](#july-2-2023 "Link to this heading")

### [New features](#id200)[](#id69 "Link to this heading")

#### [CVL](#id201)[](#id70 "Link to this heading")

*   New builtin rules: [sanity](../../cvl/builtin.html#built-in-sanity) and [deepSanity](../../cvl/builtin.html#built-in-deep-sanity)
    
*   Support a new keyword in CVL: [satisfy](../../cvl/statements.html#satisfy)
    
*   User-defined types can appear in hook patterns
    
*   Support using `currentContract` in ghosts and quantified expressions
    
*   Support conversion of `uintN` to `bytesK` with casting [Support for bytes1…bytes32](../../cvl/cvl2/changes.html#bytesn-support)
    
*   Support [nativeBalances](../../cvl/expr.html#special-fields) in CVL
...
*   Support for [EVM opcode hooks](../../cvl/hooks.html#opcode-hooks)
    

#### [CallTrace](#id202)[](#calltrace "Link to this heading")
...
#### [Summarization](#id203)[](#summarization "Link to this heading")

*   Early summarization of internal functions for improved performance and precision
    
*   [“catch-all” summaries](../../user-guide/out-of-resources/timeout.html#library-timeouts). For example, given a library `L` on which we wish to apply the same summary for all external methods in `L`, write `function L._ external => NONDET`
    

#### [Performance](#id204)[](#id71 "Link to this heading")
...
#### [Other improvements](#id205)[](#id72 "Link to this heading")
...
### [Bug fixes](#id206)[](#id73 "Link to this heading")
...
## [4.0.5 (June 7, 2023) CVL 2](#id207)[](#june-7-2023-cvl-2 "Link to this heading")

### [Breaking changes](#id208)[](#breaking-changes "Link to this heading")

*   Upgrade to CVL 2 (see [Changes Introduced in CVL 2](../../cvl/cvl2/changes.html) and [CVL2 Migration Guide](../../cvl/cvl2/migration.html))
    
*   Change the minimal python required version from 3.8.0 to 3.8.16
    

### [New features](#id209)[](#id74 "Link to this heading")

*   [Comparing storage](../../cvl/expr.html#storage-comparison)
    
*   Add support for Vyper
    
*   Support `CONSTANT` summaries for all non-dynamic return types
    
*   New [built-in rules](../../cvl/builtin.html#built-in) `sanity` and `deepSanity`
    
*   Added `--protocol_name` and `--protocol_owner` flags
    

### [Other improvements](#id210)[](#id75 "Link to this heading")
